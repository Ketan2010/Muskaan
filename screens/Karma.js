    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                <Vouchercard navigation = {navigation} reqkarma='500' type="Normal"></Vouchercard>
                <Vouchercard  navigation = {navigation} reqkarma='100' type="Premium"></Vouchercard>
                <Vouchercard  navigation = {navigation} reqkarma='50' type="Normal"></Vouchercard>
                <Vouchercard  navigation = {navigation} reqkarma='400' type="Premium"></Vouchercard>
                <Vouchercard  navigation = {navigation} reqkarma='300' type="Normal"></Vouchercard>
            </ScrollView>
        </SafeAreaView>
    )
}
